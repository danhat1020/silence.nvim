...
function M.load()
    ...
    local highlights = {
        -- Core UI
        Normal       = { fg = M.colors.grey7,      bg = M.colors.bg,         },
        NormalFloat  = { fg = M.colors.none,       bg = M.colors.bg,         },
        FloatBorder  = { fg = M.colors.grey6,      bg = M.colors.bg,         },
        ...
        LineNr       = { fg = M.colors.grey8,      bg = M.colors.bg,         },
        ...
        EndOfBuffer  = { fg = M.colors.grey2,      bg = M.colors.bg,         },
        VertSplit    = { fg = M.colors.grey1,      bg = M.colors.grey1,      },
        -- Syntax
        Statement    = { fg = M.colors.grey7,      bg = M.colors.bg,         },
        Function     = { fg = M.colors.grey7,      bg = M.colors.bg,         },
        ...
        Boolean      = { fg = M.colors.grey4,      bg = M.colors.bg,         },
        ...
        MatchParen   = { fg = M.colors.matchparen, bg = M.colors.grey2,      bold = M.config.bold },
        -- Statusline & tabs
        StatusLine   = { fg = M.colors.grey9,      bg = M.colors.grey0,      },
        StatusLineNC = { fg = M.colors.grey4,      bg = M.colors.grey0,      },
        TabLine      = { fg = M.colors.grey3,      bg = M.colors.grey5,      underline = true     },
        TabLineFill  = { fg = M.colors.grey3,      bg = M.colors.bg,         reverse = true       },
        TabLineSel   = { fg = M.colors.grey3,      bg = M.colors.bg,         },
        ...
        ModeMsg      = { fg = M.colors.grey9,      bg = M.colors.bg,         },
        MoreMsg      = { fg = M.colors.grey6,      bg = M.colors.bg,         },
        Question     = { fg = M.colors.grey3,      bg = M.colors.bg,         },
        Error        = { fg = M.colors.red,        underline = true,         sp = M.colors.red      },
        -- Folds
        FoldColumn   = { fg = M.colors.grey3,      bg = M.colors.grey2,      },
        Folded       = { fg = M.colors.grey6,      bg = M.colors.grey1,      },
        -- Misc
        Directory    = { fg = M.colors.blue,       bg = M.colors.bg,         },
        NonText      = { fg = M.colors.grey6,      bg = M.colors.bg,         },
        SpecialKey   = { fg = M.colors.grey2,      bg = M.colors.bg,         },
        SignColumn   = { fg = M.colors.grey7,      bg = M.colors.bg,         },
        Title        = { fg = M.colors.grey5,      bg = M.colors.bg          },
        WildMenu     = { fg = M.colors.black,      bg = M.colors.grey6,      },
        Operator     = { fg = M.colors.grey7,      bg = M.colors.bg,         },
        -- Spell
        SpellBad     = { bg = M.colors.black,      sp = M.colors.red,        underline = true     },
        SpellCap     = { sp = M.colors.grey3,      underline = true          },
        SpellLocal   = { sp = M.colors.grey2,      underline = true          },
        SpellRare    = { sp = M.colors.grey5,      underline = true          },
        -- Quickfix
        qfFileName   = { fg = M.colors.grey4,      bg = M.colors.bg,         italic = true        },
        qfLineNr     = { fg = M.colors.grey3,      bg = M.colors.bg,         },
        qfError      = { fg = M.colors.grey3,      bg = M.colors.black,      underline = true     },
        -- Taglist
        MyTagListFileName = { fg = M.colors.grey9, bg = M.colors.grey2,      },
        MyTagListTitle    = { fg = M.colors.grey4, bg = M.colors.bg,         },
        -- Vim-specific
        VimError          = { fg = M.colors.grey9, bg = M.colors.grey2,      },
        -- Links
        ...
        -- Treesitter
        ['@variable']             = { fg = M.colors.grey8,      bg = M.colors.bg },
        ['@variable.builtin']     = { fg = M.colors.grey6,      bg = M.colors.bg },
        ['@variable.parameter']   = { fg = M.colors.light_blue, bg = M.colors.bg },
        ['@variable.member']      = { fg = M.colors.grey7,      bg = M.colors.bg },
        ['@constant']             = { fg = M.colors.constant,   bg = M.colors.bg },
        ...
        ['@function']             = { fg = M.colors.grey7,      bg = M.colors.bg },
        ['@function.builtin']     = { fg = M.colors.grey6,      bg = M.colors.bg },
        ['@function.call']        = { fg = M.colors.grey7,      bg = M.colors.bg },
        ['@function.method']      = { fg = M.colors.grey7,      bg = M.colors.bg },
        ['@function.method.call'] = { fg = M.colors.grey7,      bg = M.colors.bg },
        ['@type']                 = { fg = M.colors.type,       bg = M.colors.bg },
        ['@type.builtin']         = { fg = M.colors.type,       bg = M.colors.bg },
        ['@operator']             = { fg = M.colors.grey7,      bg = M.colors.bg },
        ['@punctuation.bracket']  = { fg = M.colors.grey4,      bg = M.colors.bg },
        ['@punctuation.delimiter']= { fg = M.colors.grey4,      bg = M.colors.bg },
        ['@tag']                  = { fg = M.colors.grey6,      bg = M.colors.bg },
        ['@tag.attribute']        = { fg = M.colors.light_blue, bg = M.colors.bg },
        ['@tag.delimiter']        = { fg = M.colors.grey4,      bg = M.colors.bg },
    }
...
function M.set_terminal_colors()
    ...
    vim.g.terminal_color_7  = M.colors.grey7      -- white

    vim.g.terminal_color_8  = M.colors.grey2      -- bright black
